...
const OverviewButton = ( props: {Status: string, Id: string, Filter: string, HexColor: string, href: string, percentage: number} ) => {
    ...
    const handleClick = () => {
        ...
        else if (props.Id == "Critical-goto-btn") {
            changeFilter(3)
        }
    ...
    return (
        ...
        <div className=" w-[25%] sm:w-[18%] md:w-[13%] h-32 ">
            ...
            <button onClick={handleClick} className=" w-full h-32 lg:h-36 bg-component1 text-center rounded-[3px] shadow-2xl">
            ...
            <button onClick={handleClick} className=" w-full bg-component1 mt-3 rounded-[3px] shadow-2xl">
